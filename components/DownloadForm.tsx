...
export default function DownloadForm() {
    ...
    >
      <div className="flex gap-4">
        ...
        <div className="flex-shrink-0">
          <div className="w-32 h-20 bg-gray-300 dark:bg-gray-700 rounded overflow-hidden relative">
            {result.thumbnail && (
              <Image
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-xl">YouTube 다운로드</CardTitle>
      </CardHeader>
      <CardContent>
        {error && (
        ...
        <Tabs defaultValue="search" className="w-full">
          ...
          <TabsContent value="search" className="space-y-4 mt-4">
            <div className="space-y-2">
              <Label htmlFor="search">곡명 또는 아티스트 검색</Label>
